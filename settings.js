...
global.owner = process.env.OWNER_NUMBER  || '9947275369' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=GJlylDCA#yyot8MlS1swzfUs1VDdsDcZHlSv9pMC72i__n_bazUA' ,
